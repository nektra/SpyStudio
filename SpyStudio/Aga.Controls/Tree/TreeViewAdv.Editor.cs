...
namespace Aga.Controls.Tree
{
	partial class TreeViewAdv
	{
	    ...
	    public TreeNodeAdv EditingNode
	    {
	        get { return _editingNode; }
	    }
		...
		internal void DisplayEditor(Control editor, EditableControl owner)
		{
            ...
            _editingNode = GetTreeNode(CurrentNode);
		    Debug.Assert(_editingNode != null);
		...
		internal bool HideEditor(bool applyChanges)
		{
			if (CurrentEditor != null)
			{
				...
				if (CurrentEditor != null)
				{
                    // avoid to enter this code twice
                    var editor = CurrentEditor;
				    CurrentEditor = null;
                    editor.Validating -= EditorValidating;
                    CurrentEditorOwner.DoDisposeEditor(editor);
		...
		public void UpdateEditorBounds()
		{
            ...
            if (_editingNode != null && CurrentEditor != null)
			{
			    var context = new EditorContext
			                      {
			                          Owner = CurrentEditorOwner,
                                      CurrentNode = _editingNode,
