	...
	public abstract class NodeControl : Component
	{
		...
		public TreeColumn ParentColumn
		{
			...
			{ 
				_parentColumn = value; 
				if (_parent != null)
					_parent.UpdateControl(true, true);
			}
		}
		...
		public event EventHandler<NodeTreeControlValueEventArgs> IsVisibleValueNeeded;
		protected virtual void OnIsVisibleValueNeeded(NodeTreeControlValueEventArgs args)
		{
