...
namespace Aga.Controls.Tree.NodeControls
{
	internal class NodePlusMinus : NodeControl
	{
        ...
        public const int ExpandedEndArrow = 10;
	    public const int ExpandedEndArrowWidth = 4;
		...
		{
			_plus = Resources.collapsed;
			_minus = Resources.expanded;
		}
		...
		public override void MouseDown(TreeNodeAdvMouseEventArgs args)
		{
			...
			{
				args.Handled = true;
				if (args.TreeNode.CanExpand)
					args.TreeNode.Node.IsExpanded = !args.TreeNode.Node.IsExpanded;
			}
		}
