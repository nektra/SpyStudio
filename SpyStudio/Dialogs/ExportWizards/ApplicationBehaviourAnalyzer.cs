    ...
    public class ApplicationBehaviourAnalyzer
    {
        ...
        public IEnumerable<string> ApplicationRelatedWords
        {
            get
            {
                ...
                return _applicationRelatedWords.Except(NonRepresentativeWords).ToList();
            }
        }
        ...
        private void ExtractMainProcessPropertiesFrom(FileSystemTree aFileSystemTree)
        {
            ...
            {
                var productName = callEvent.GetPropertyString("Product");
                var companyName = callEvent.GetPropertyString("Company");
                var mainProcessOriginalFileName = callEvent.GetPropertyString("OriginalFileName");
        ...
        private void ExtractProgramFilesFolderPathFrom(FileSystemTree aFileSystemTree)
        {
            ...
            if (mainProcessFileNode == null || !programFilesFolderRegex.IsMatch(mainProcessFileNode.FilePath))
            {
            ...
            ExpandedProgramFilesFolderPath = PathNormalizer.EnsureSingleBackslashesIn(ThinAppPathNormalizer.GetInstance().UndoNormalizationOf(ProgramFilesFolderPath));
        ...
        private void ExtractCommonProgramFilesFolderPathFrom(FileSystemTree aFileSystemTree)
        {
            ...
            ExpandedCommonProgramFilesFolderPath = PathNormalizer.EnsureSingleBackslashesIn(ThinAppPathNormalizer.GetInstance().UndoNormalizationOf(CommonProgramFilesFolderPath));
        }
